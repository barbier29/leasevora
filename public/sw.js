const CACHE_NAME = 'leasevora-v19';

const STATIC_ASSETS = [
  '/',
  '/style.css?v=18',
  '/app.js?v=18',
  '/pages/dashboard.js?v=18',
  '/pages/properties.js?v=18',
  '/pages/units.js?v=18',
  '/pages/locataires.js?v=18',
  '/pages/sejours.js?v=18',
  '/pages/calendrier.js?v=18',
  '/pages/transactions.js?v=18',
  '/pages/caisse.js?v=18',
  '/pages/comptes.js?v=18',
  '/pages/finance.js?v=18',
  '/pages/paiements.js?v=18',
  '/pages/travaux.js?v=18',
  '/pages/compteurs.js?v=18',
  '/pages/categories.js?v=18',
  '/pages/notes.js?v=18',
  '/pages/users.js?v=18',
];
