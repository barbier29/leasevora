const CACHE_NAME = 'leasevora-v20';

const STATIC_ASSETS = [
  '/',
  '/style.css?v=19',
  '/app.js?v=19',
  '/pages/dashboard.js?v=19',
  '/pages/properties.js?v=19',
  '/pages/units.js?v=19',
  '/pages/locataires.js?v=19',
  '/pages/sejours.js?v=19',
  '/pages/calendrier.js?v=19',
  '/pages/transactions.js?v=19',
  '/pages/caisse.js?v=19',
  '/pages/comptes.js?v=19',
  '/pages/finance.js?v=19',
  '/pages/paiements.js?v=19',
  '/pages/travaux.js?v=19',
  '/pages/compteurs.js?v=19',
  '/pages/categories.js?v=19',
  '/pages/notes.js?v=19',
  '/pages/users.js?v=19',
];
