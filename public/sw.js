const CACHE_NAME = 'leasevora-v18';

const STATIC_ASSETS = [
  '/',
  '/style.css?v=17',
  '/app.js?v=17',
  '/pages/dashboard.js?v=17',
  '/pages/properties.js?v=17',
  '/pages/units.js?v=17',
  '/pages/locataires.js?v=17',
  '/pages/sejours.js?v=17',
  '/pages/calendrier.js?v=17',
  '/pages/transactions.js?v=17',
  '/pages/caisse.js?v=17',
  '/pages/comptes.js?v=17',
  '/pages/finance.js?v=17',
  '/pages/paiements.js?v=17',
  '/pages/travaux.js?v=17',
  '/pages/compteurs.js?v=17',
  '/pages/categories.js?v=17',
  '/pages/notes.js?v=17',
  '/pages/users.js?v=17',
];
