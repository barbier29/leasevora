const CACHE_NAME = 'leasevora-v17';

const STATIC_ASSETS = [
  '/',
  '/style.css?v=16',
  '/app.js?v=16',
  '/pages/dashboard.js?v=16',
  '/pages/properties.js?v=16',
  '/pages/units.js?v=16',
  '/pages/locataires.js?v=16',
  '/pages/sejours.js?v=16',
  '/pages/calendrier.js?v=16',
  '/pages/transactions.js?v=16',
  '/pages/caisse.js?v=16',
  '/pages/comptes.js?v=16',
  '/pages/finance.js?v=16',
  '/pages/paiements.js?v=16',
  '/pages/travaux.js?v=16',
  '/pages/compteurs.js?v=16',
  '/pages/categories.js?v=16',
  '/pages/notes.js?v=16',
  '/pages/users.js?v=16',
];
